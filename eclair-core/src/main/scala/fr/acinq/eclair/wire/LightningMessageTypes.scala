...
/**
  *
  * @param chainHash chain hash
  * @param data prefix + list of (short channel id | flag), where prefix specifies how the list is encoded, and flag
  *             specifies wether we want channel_announcement + channel_updates or just channel_updates
  */
